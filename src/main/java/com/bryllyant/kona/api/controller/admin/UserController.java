 ...
 */
package com.bryllyant.kona.api.controller.admin;

import com.bryllyant.kona.api.controller.BaseController;
import com.bryllyant.kona.api.controller.auth.AuthController;
import com.bryllyant.kona.api.model.ModelResultSet;
import com.bryllyant.kona.api.model.auth.AuthSessionModel;
import com.bryllyant.kona.api.model.auth.RegistrationRequest;
...
//                    break;
                ...
                case "birthDate":
                    ...
                    SimpleDateFormat df = new SimpleDateFormat(AppUtil.BIRTH_DATE_FORMAT);
                    try {
