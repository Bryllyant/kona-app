...
@RestController
@RequestMapping("/api/admin/campaigns/landing-pages")
public class LandingPageController extends BaseController {
    ...
    public ResponseEntity<ModelResultSet<LandingPageModel>> search(
        ...
        logApiRequest(req, "GET /admin/campaigns/landing-pages");
    ...
    public ResponseEntity<LandingPageModel> get(
        ...
        logApiRequest(req, "GET /admin/campaigns/landing-pages/" + uid);
    ...
    public ResponseEntity<LandingPageModel> create(
        ...
        logApiRequest(req, "POST /admin/campaigns/landing-pages");
    ...
    public ResponseEntity<LandingPageModel> update(
        ...
        logApiRequest(req, "PUT /admin/campaigns/landing-pages/" + uid);
    ...
    public ResponseEntity<LandingPageModel> remove(
        ...
        logApiRequest(req, "DELETE /admin/campaigns/landing-pages/" + uid);
