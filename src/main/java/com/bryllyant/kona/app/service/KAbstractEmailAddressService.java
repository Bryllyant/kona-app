...
import com.bryllyant.kona.app.util.KMailboxValidator;
...
public abstract class KAbstractEmailAddressService<EMAIL_ADDRESS extends KEmailAddress, EMAIL_ADDRESS_EXAMPLE extends KEntityExample, MAPPER extends KMyBatisMapper<EMAIL_ADDRESS, EMAIL_ADDRESS_EXAMPLE>,
        EMAIL_GROUP extends KEmailGroup,
        EMAIL_GROUP_ADDRESS extends KEmailGroupAddress>
        extends KAbstractService<EMAIL_ADDRESS, EMAIL_ADDRESS_EXAMPLE,MAPPER>
    ...
    @Override
    public List<EMAIL_ADDRESS> fetchRandom(Long count, List<String> sourceList, List<String> excludeGroupSlugList) {
        ...
        if (excludeGroupSlugList != null) {
            ...
            for (String slug : excludeGroupSlugList) {
                EMAIL_GROUP group = getEmailGroupService().fetchBySlug(slug);
