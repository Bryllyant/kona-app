...
public abstract class KAbstractNotificationService< Notification extends KNotification, 
													NotificationExample extends KEntityExample,
        MAPPER extends KMyBatisMapper<Notification, NotificationExample>,
													NotificationDelivery extends KNotificationDelivery,
													User extends KUser>
		extends KAbstractService<Notification,NotificationExample,MAPPER>
	...
	protected abstract boolean isChannelEnabled(Long userId, String event, Notification.Channel channel);
	...
	public void notifyEvent(Long userId, String event, Date eventDate) {
		...
		Notification.Channel channels[] = Notification.Channel.values();
	...
	protected NotificationDelivery createDelivery(Notification notification, Notification.Channel channel) {
