...
public abstract class KAbstractEmailGroupService<EMAIL_GROUP extends KEmailGroup, EMAIL_GROUP_EXAMPLE extends KEntityExample, MAPPER extends KMyBatisMapper<EMAIL_GROUP, EMAIL_GROUP_EXAMPLE>,
        EMAIL_ADDRESS extends KEmailAddress,
        EMAIL_GROUP_ADDRESS extends KEmailGroupAddress>
        extends KAbstractService<EMAIL_GROUP, EMAIL_GROUP_EXAMPLE,MAPPER>
    ...
    @Override
    public EMAIL_GROUP fetchBySlug(String slug) {
    ...
    @Override
    public List<EMAIL_GROUP_ADDRESS> fetchGroupAddressList(String slug) {
        EMAIL_GROUP group = fetchBySlug(slug);
    ...
    @Override
    public EMAIL_GROUP_ADDRESS addGroupAddress(String slug, String email) {
        EMAIL_GROUP group = fetchBySlug(slug);
    ...
    @Override
    public EMAIL_GROUP_ADDRESS removeGroupAddress(String slug, String email) {
        EMAIL_ADDRESS address = getEmailAddressService().fetchByEmail(email);
        EMAIL_GROUP group = fetchBySlug(slug);
    ...
    @Override
    public void addGroupAddressList(String slug, List<EMAIL_ADDRESS> emailAddressList) {
        EMAIL_GROUP group = fetchBySlug(slug);
