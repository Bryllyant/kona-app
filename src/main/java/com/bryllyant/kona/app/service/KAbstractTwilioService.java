...
public abstract class KAbstractTwilioService<SMS extends KSms, SMS_EXAMPLE extends KEntityExample, MAPPER extends KMyBatisMapper<SMS, SMS_EXAMPLE>,USER extends KUser>
    extends KAbstractService<SMS, SMS_EXAMPLE,MAPPER>
    ...
    public abstract String getMessageStatusCallbackUrl();
