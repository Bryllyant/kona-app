...
public abstract class KAbstractRedirectService<REDIRECT extends KRedirect, REDIRECT_EXAMPLE extends KEntityExample, MAPPER extends KMyBatisMapper<REDIRECT, REDIRECT_EXAMPLE>,
        SHORTURL extends KShortUrl>
        extends KAbstractService<REDIRECT,REDIRECT_EXAMPLE,MAPPER>
