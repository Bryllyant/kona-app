...
import com.bryllyant.kona.data.entity.KEnumObject;
import com.bryllyant.kona.data.entity.KEnumUtil;

import java.util.LinkedHashMap;

public enum Currency implements KEnumObject {
    ...
    private Currency(int id, String country, String displayName) {
    ...
    public static Currency getInstance(Long id) {
        return KEnumUtil.getInstance(Currency.class, id);
    }

    public static LinkedHashMap<Long,String> getMap() {
        return KEnumUtil.getMap(Currency.class);
    }

    public static LinkedHashMap<String,String> getStringMap() {
        return KEnumUtil.getStringMap(Currency.class);
    }
}
